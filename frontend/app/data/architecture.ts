...
export const desktopNavigation: LinkItem[] = [
  {
    ...
    children: [
      ...
      { label: "Kizhi", href: "/treatments/njavarakizhi" },
      { label: "Kati Basti", href: "/treatments/kati-basti" },
      { label: "Vasti", href: "/treatments/basti" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Media & Gallery Hub", href: "/gallery" },
...
export const doctorsDirectory: DoctorDirectoryItem[] = [
  ...
  },
  {
    ...
    meta: "BAMS, MD (Ayur) | Chief Medical Officer & Hospital Director",
    text: "Chief Physician with 24+ years clinical experience in classical Panchakarma, severe degenerative spine disorders, chronic arthritis, and research-backed Ayurveda care. Son of the late Prof. Dr. Krishnankutty Nair.",
    image: "/images/doctor-portrait.webp",
    experience: "24+ Years",
    patients: "15K+",
    availability: "Kattakada & Kowdiar (On Appointment)",
    languages: ["English", "Malayalam", "Hindi"],
    credentials: ["BAMS", "MD (Ayur)", "Chief Medical Officer & Hospital Director", "MBA Hospital Management"],
    focusAreas: ["Panchakarma Detoxification", "Spine Disc Herniation", "Rheumatoid Arthritis", "Severe Degenerative Care"],
    approach: ["Clinical assessment", "Root-cause care planning", "Therapy and medicine guidance", "Review-based optimization"],
    quote: "Healing works best when 55 years of authentic family Ayurveda lineage meets rigorous clinical evidence.",
  },
  {
    slug: "dr-sreeja-krishna-s",
    title: "Dr. Sreeja Krishna S.",
    meta: "BAMS | Senior Consultant Physician",
    text: "Principal physician specializing in general Ayurveda medicine, Panchakarma detoxification, metabolic health, skin care, and lifestyle disease management.",
    image: "/images/doctor-portrait.webp",
    experience: "18+ Years",
    patients: "10K+",
    availability: "Tue, Thu, Sat (Kowdiar & Kattakada)",
    languages: ["English", "Malayalam"],
    credentials: ["BAMS", "Senior Consultant Physician", "Panchakarma & General Medicine"],
    focusAreas: ["Panchakarma Detox", "Metabolic Disorders", "Psoriasis & Skin Care", "Chronic Disease Management"],
    approach: ["Detailed constitution review", "Personalized therapy selection", "Diet and routine correction", "Follow-up wellness support"],
    quote: "Authentic Ayurveda care should be compassionate, understandable, and deeply personalized for every family.",
  },
  {
    slug: "dr-priyanka-r",
    title: "Dr. Priyanka R.",
    meta: "BAMS, MS (Ayur) | Ayurvedic Gynaecologist & Obstetrician",
    text: "Specialist Ayurvedic Gynaecologist & Obstetrician providing clinical care for PCOD/PCOS, infertility preparation, pregnancy care, antenatal wellness, and postnatal restoration.",
    image: "/images/doctor-portrait.webp",
    experience: "10+ Years",
    patients: "6K+",
    availability: "Sun, Mon, Wed, Fri (Kattakada & Kowdiar)",
    languages: ["English", "Malayalam"],
    credentials: ["BAMS", "MS (Ayur)", "Ayurvedic Gynaecology and Obstetrics Specialist"],
    focusAreas: ["PCOD / PCOS Management", "Ayurvedic Infertility Care", "Antenatal & Postnatal Restorative Care", "Menstrual Health"],
    approach: ["Sensitive specialist consultation", "Stage-wise clinical care planning", "Dietary and herbal therapy guidance", "Continuity of care"],
    quote: "Women's healthcare requires deep clinical expertise, patience, and gentle Ayurvedic care that respects every phase of life.",
  },
  {
    slug: "dr-rajesh-r",
    title: "Dr. Rajesh R.",
