...
export function FloatingActionButtons() {
  ...
  return (
    <div className="floating-buttons-container" ref={chatRef} aria-label="Floating Actions">
      {/* WhatsApp Representative Selection Modal */}
      {isChatOpen && (
        <div className="whatsapp-chat-modal" role="dialog" aria-label="WhatsApp Chat Representatives">
          <div className="whatsapp-chat-header">
            <div className="whatsapp-chat-header-content">
              <h4 className="whatsapp-chat-title">Need Help? Chat with us</h4>
              <p className="whatsapp-chat-subtitle">Click one of our representatives below</p>
            </div>
            <button
              type="button"
          ...
          <div className="whatsapp-chat-body">
            {/* Representative 1: Kattakada */}
            <a
              href="https://wa.me/919447003191?text=Hello%20Susrutha%20Ayurveda%20(Kattakada%20Branch),%20I%20would%20like%20to%20inquire%20about%20your%20services."
              target="_blank"
              rel="noopener noreferrer"
              className="whatsapp-rep-card"
              onClick={() => setIsChatOpen(false)}
            >
              <div className="whatsapp-rep-avatar">
                <Image
                  src="/images/susrutha-logo.webp"
                  alt="Kattakada Branch"
                  width={44}
                  height={44}
                  style={{ objectFit: "contain" }}
                />
              </div>
              <div className="whatsapp-rep-info">
                <h5 className="whatsapp-rep-name">Kattakada</h5>
                <p className="whatsapp-rep-desc">
                  Susrutha Institute of Ayurvedic Sciences (Research) and Panchakarma Hospital
                </p>
              </div>
            </a>

            {/* Representative 2: Kowdiar */}
            <a
              href="https://wa.me/919447003191?text=Hello%20Susrutha%20Ayurveda%20(Kowdiar%20Branch),%20I%20would%20like%20to%20inquire%20about%20your%20services."
              target="_blank"
              rel="noopener noreferrer"
              className="whatsapp-rep-card"
              onClick={() => setIsChatOpen(false)}
            >
              ...
              <div className="whatsapp-rep-info">
                <h5 className="whatsapp-rep-name">Kowdiar</h5>
                <p className="whatsapp-rep-desc">
                  Susrutha Panchakarma Hospital OP Outlet
                </p>
              </div>
            </a>
          </div>
